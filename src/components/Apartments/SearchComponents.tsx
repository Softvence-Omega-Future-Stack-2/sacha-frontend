...
//   const [location, setLocation] = useState(""); // এখন ফ্রি টেক্সট ইনপুট
...
//         {/* Location - এখন পুরোপুরি ইনপুট ফিল্ড */}
//         <div className="relative w-full">
//           <div className="w-full bg-white rounded-xl top-2 relative transition-all duration-300">
//             <div className="p-3">
//               <label className="text-sm text-gray-500 block mb-1 font-medium">
...
//                   className="w-full outline-none text-gray-800 font-semibold placeholder-gray-400 focus:placeholder-gray-500"
//                 />
//               </div>
//             </div>
//           </div>
