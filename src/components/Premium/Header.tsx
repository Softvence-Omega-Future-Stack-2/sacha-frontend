        ...
        <div className="grid grid-cols-1 container mx-auto lg:grid-cols-2 gap-12 items-start">
          ...
          <div className='lg:px-10'>
            <h1 className="text-3xl lg:text-5xl font-semibold text-[#061251] leading-tight mb-4">
              Apply For <br />
              <span className="larken-font font-normal">The Apartments!</span>
            </h1>
            ...
            <div className="space-y-6 mb-12">
              {[
                "Your profile is sent to the owners and they contact you directly.",
                "Apply to all HelloAppart apartments",
                "100% private sale, no agency fees to pay",
            ...
            <div className="flex space-x-8">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex-1">
                ...
                <p className="text-[#061251]">More luck</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex-1">
                <p className="text-4xl font-semibold text-blue-900">100%</p>
                <p className="text-[#061251]">Secure</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 lg:p-10 mt-4 rounded-3xl relative w-full max-w-md mx-auto">
            <div className="flex justify-between items-center mb-8">
              <div>
                <p className="text-gray-600 text-lg italic mb-1">Try it for</p>
            ...
            <p className="text-gray-700 text-lg mb-8">
              No commitment required, cancel at any time.
            </p>
            ...
            <button
              ...
              disabled={isLoading}
              className={`w-full relative bg-[#256AF4] text-white py-4 px-6 rounded-xl text-xl font-normal transition-all duration-300 flex items-center justify-center ${
                isLoading 
            ...
            <p className="text-center text-gray-500 text-sm">
              A rating of 4.8 out of 5 based on 1659 reviews. Our 4 and 5 star reviews.
            </p>
          </div>
        </div>
      </div>
