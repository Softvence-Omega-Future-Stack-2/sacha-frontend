...
const testimonials: Testimonial[] = [
  {
    id: 1,
    text: "Nous avons maintenant acquis plusieurs propriétés auprès de ClearEquite. J'ai principalement été en contact avec Jay Luo. C'est une personne agréable et avec qui il est facile de travailler. Je continuerai à collaborer avec eux pour mes futurs projets de rénovation.",
    name: "Propriétés chanceuses",
    role: "Analyste de trading senior",
    avatar: user1,
  },
  {
    id: 2,
      ...
      <div className=" max-w-6xl mx-auto bg-[#F2F6FE] py-12 px-4 sm:px-6 lg:px-8">
        <div>
          ...
          <div className="flex justify-between items-start mb-16">
            <h2 className=" sm:text-2xl lg:text-4xl text-[#061251] font-dm-sans text-3xl font-semibold leading-[120%]">
              Que <span className="font-normal text-[#061251] larken-font leading-[120%]">Clients</span>
              <br />
              disent sur nous
            </h2>
